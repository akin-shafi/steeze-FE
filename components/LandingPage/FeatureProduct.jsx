...
const products = [
  { id: 1, name: "Classic T-Shirt", price: "$19.99", rating: 4.5, image: "/placeholder.svg?height=200&width=200&text=T-Shirt" },
  { id: 2, name: "Denim Jeans", price: "$49.99", rating: 4.2, image: "/placeholder.svg?height=200&width=200&text=Jeans" },
  { id: 3, name: "Leather Jacket", price: "$99.99", rating: 4.8, image: "/placeholder.svg?height=200&width=200&text=Jacket" },
  { id: 4, name: "Sneakers", price: "$79.99", rating: 4.3, image: "/placeholder.svg?height=200&width=200&text=Sneakers" },
  { id: 5, name: "Wool Sweater", price: "$59.99", rating: 4.6, image: "/placeholder.svg?height=200&width=200&text=Sweater" },
  { id: 6, name: "Summer Dress", price: "$39.99", rating: 4.4, image: "/placeholder.svg?height=200&width=200&text=Dress" },
  { id: 7, name: "Formal Suit", price: "$149.99", rating: 4.7, image: "/placeholder.svg?height=200&width=200&text=Suit" },
  { id: 8, name: "Silk Scarf", price: "$29.99", rating: 4.1, image: "/placeholder.svg?height=200&width=200&text=Scarf" },
]
      ...
      <section className="mb-12">
        <div className="flex flex-wrap justify-between items-center mb-6 border-y-2 py-4">
          ...
          <div className="space-x-2 md:space-x-4">
            <Button variant="outline" className="rounded-full">Tailoring</Button>
            <Button variant="outline" className="rounded-full">Fabrics</Button>
          </div>
        </div>
